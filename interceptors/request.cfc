...
Author:  Mark Skelton
Description:  Intercepts events starting with reftagger and preprocess with ContentBox admin
*/
component extends="coldbox.system.Interceptor"{
	...
	*/
	function preProcess( event, interceptData, rc, prc ) eventPattern="^cbmodule-reftagger" {
